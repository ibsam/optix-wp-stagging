		...
		$this->register_section(
			...
			[
				...
				[
					...
					'url'      => 'https://affiliatewp.com/docs/affiliate-link-sharing',
					'external' => true,
				],
			],
		);
		...
		affiliate_wp()->settings->register_section(
			...
			[
				...
				[
					'type'     => 'link',
					'text'     => __( 'Learn more', 'affiliate-wp' ),
					'url'      => 'https://affiliatewp.com/docs/multi-tier-commissions',
					'external' => true,
				],
			],
		);
			...
			'affiliates_page' => [
				...
				'tooltip' => [
					...
					[
						'type'     => 'link',
						'text'     => __( 'Learn more', 'affiliate-wp' ),
						'url'      => 'https://affiliatewp.com/docs/affiliate-account-page',
						'external' => true,
					],
				],
			],
			'affiliates_login_page' => [
				...
				'tooltip' => [
					...
					[
						'type'     => 'link',
						'text'     => __( 'Learn more', 'affiliate-wp' ),
						'url'      => 'https://affiliatewp.com/docs/affiliate-login-page',
						'external' => true,
					],
				],
			],
			'affiliates_registration_page' => [
				...
				'tooltip' => [
					...
					[
						'type'     => 'link',
						'text'     => __( 'Learn more', 'affiliate-wp' ),
						'url'      => 'https://affiliatewp.com/docs/affiliate-registration-page',
						'external' => true,
					],
				],
			],
			...
			'commission_holding_period' => [
				...
				'tooltip' => [
					...
					[
						'type'     => 'link',
						'text'     => __( 'Learn more', 'affiliate-wp' ),
						'url'      => 'https://affiliatewp.com/docs/paying-your-affiliates/#commission-holding-period',
						'external' => true,
					],
				],
			],
