...
class Affiliate_WP_Membermouse extends Affiliate_WP_Base {
	...
	public function init() {
		...
		add_action( 'mm_member_add', [ $this, 'add_referral_on_free' ], 10 );
		add_action( 'mm_commission_initial', [ $this, 'add_referral' ], 10 );
		add_action( 'mm_refund_issued', [ $this, 'revoke_referral_on_refund' ], 10 );
