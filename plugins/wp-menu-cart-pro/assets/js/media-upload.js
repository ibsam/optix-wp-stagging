...
jQuery(document).ready(function($) {
	...
	$('#wpo-wpmenucart-settings').on('click', '.wpo_upload_image_button', function( event ){
		...
		file_frame.on( 'select', function() {
			...
			if ($( '#img-'+input_id_clean ).length){
				...
				attachment_img = '<img src="'+attachment.url+'" style="display:block;max-width:150px;max-height:150px;margin-bottom:10px" id="img-'+input_id_clean+'"/>';
	...
	$('#wpo-wpmenucart-settings').on('click', '.wpo_remove_image_button', function( event ){
