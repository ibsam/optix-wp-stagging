...
abstract class Plugin extends BooklyLib\Base\Plugin
{
    ...
    protected static function init()
    {
        ...
        Backend\Components\Gutenberg\CustomerGiftCards\Block::init();
        ...
        if ( ! is_admin() ) {
            ...
            Frontend\Modules\CustomerGiftCards\ShortCode::init();
            ...
            Frontend\Modules\TagsForm\ShortCode::init();
        }
    }
    ...
    protected static function registerAjax()
    {
        ...
        Backend\Components\Dialogs\Service\Tags\Ajax::init();
        ...
        Frontend\Modules\CustomerGiftCards\Ajax::init();
