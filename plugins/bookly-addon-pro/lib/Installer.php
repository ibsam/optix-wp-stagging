...
class Installer extends Base\Installer
{
    ...
    public function __construct()
    {
        ...
        $this->options = array(
            ...
            'bookly_pro_licensed_products' => 'undefined',
            // Appearance.
            ...
            'bookly_temporary_logs_google' => '0',
            'bookly_tag_colors' => array( '#17a2b8', '#6c757d', '#28a745', '#dc3545', '#ffc107', '#007bff', '#343a40' ),
        );
    }
    ...
    public function createTables()
    {
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Entities\Form::getTableName() . '` (
                `id` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
                `type` ENUM("search-form","services-form","staff-form","cancellation-confirmation","tags-form","events-form") NOT NULL DEFAULT "search-form",
                `name` VARCHAR(255) NOT NULL,
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Entities\Tag::getTableName() . '` (
                `id`  INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
                `type` ENUM("customer","service") NOT NULL DEFAULT "customer",
